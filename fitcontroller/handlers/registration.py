...
GREETING = (
    "💪 Привет! Я FitController — помогу навести порядок в тренировках.\n\n"
    "🏋️ Составлю программу под твою цель\n"
    "📝 Запомню веса и подскажу их в следующий раз\n"
    "📊 Буду вести полную статистику твоего прогресса исходя из твоих целей\n"
    "📸 А есть своя программа? Просто пришли фото — я её пойму.\n\n"
    "ЭТО ТЕСТОВЫЙ КОНТУР, ФУНКЦИОНАЛ БУДЕТ ДОРАБАТЫВАТЬСЯ. ПОЖАЛУЙСТА, ПИШИТЕ, "
    "ЕСЛИ ЧТО-ТО НЕУДОБНО, ЕСТЬ ЗАМЕЧАНИЯ ИЛИ ПРЕДЛОЖЕНИЯ — СРАЗУ В САППОРТ "
    "(В РАЗДЕЛЕ МЕНЮ).\n\n"
    "Начнём с профиля 👇"
)
